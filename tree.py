...
class Bird:
    ...
    flap_sound = pygame.mixer.Sound('python_0390_pygame_flappy_bird_sound_flap.wav')
    hit_sound = pygame.mixer.Sound('python_0390_pygame_flappy_bird_sound_hit.wav')
...
class Pipe:
    ...
    bottom_pipe_y_choices = [450, 550, 650]
...
class Score:
    ...
    point_sound = pygame.mixer.Sound('python_0390_pygame_flappy_bird_sound_point.wav') # STEP 4) CODE ADD
